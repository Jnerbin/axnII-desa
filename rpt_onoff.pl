...
sub ArmoConsulta {
   ...
   print "<span style='font-weight: bold;'>Informe de Paradas con motor Encendido<br><br></span>";
   print "<div style='text-align:left; font-family: Arial'><br>";
      print "<TABLE>";
        ...
        print "<tr>";
          ...
          print "<td><input name='tpo_stop' size='2' value='45'>$tb ";
          print "<br></td>";
          print "<td></tr>";
      print "</TABLE>";
...
print "<h2>Vehiculos Detenidos con Motor Encendido por mas de $xstop minutos<br> Fecha $fecha</h2>";
...
#         print "   ENCENDIO entre las $hora y las $eventos[0]<br>";
 ...
 print "<td><a href='http://maps.google.com/maps?q=$posiciones[3]+$posiciones[4]&t=k&z=14' target='blank'>Mapa</a></td></tr>";
