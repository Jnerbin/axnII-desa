...
$GM_KEY = "ABQIAAAAXwxNGyleOVAL1oKtaNhnCxTspAEIl9p2THfGx0J5r8ksZu-IQRQ4_npbrJ4bWgo8frwnVZzqKEiv3Q";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body onload="onLoad()" onunload="GUnload()">
     ...
     var cuantos = 0;    
     var xIcon = new GIcon();
     xIcon.image      = "http://www.dtsa.com.do/axnII/iconos/dir/red-000.png";
     xIcon.shadow     = "http://www.dtsa.com.do/axnII/iconos/dir/shadow.png";
     ...
     xIcon.infoWindowAnchor = new GPoint(12, 12);
      ...
      var AxnMTiles = function (a,b) {
          var f = "http://www.dtsa.com.do/DTSA/Tiles/" + TileToQuadKey(a.x,a.y,b) + ".jpg";
          return f;
      }
	...
	if ( color == 'white' ) { nombre = 'pto_rojo.png'; }
        xIcon.image = "http://www.dtsa.com.do/axnII/iconos/dir/"+nombre;
        return xIcon;
      }
