...
$Knivel   	= 0;
$Kcateg   	= 0;
$KpathMapas 	= "/var/www/html/axnII/Cartas";
...
$GM_KEY = "ABQIAAAAZNxuIilzeBkODlv1C8plNRSPzzVNfIh7jmfSNoAAk8U1sXvCVRQcxQ62GRM4joDNd78AVQJVH0COdg";
...
sub xy2latlon {
   my ($x, $y, $mapa) = @_;
   my $rm = $dbh->prepare("SELECT * from Cartas WHERE mapa = ?");
   $rm->execute($mapa);
