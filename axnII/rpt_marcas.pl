...
sub AnalizoOpciones {
   ...
   &RptResumenDeFlota($vehiculo, $if_fecini, $if_fecfin);
}
#====================================================================================
sub RptResumenDeFlota {
    my ($vehiculo, $x_fecini, $x_fecfin) = @_;
    my $sqlq_ve;
    if ($vehiculo eq "0") {
...
#    Armamos lista de Ciudades/Mapas
   ...
   # Desplegamos el Form
   print start_form();
   print "<span style='font-weight: bold;'>Marcas Diarias de Vehiculos<br><br></span>";
   print "<div style='text-align:left;'><br>";
      print "<TABLE>";
        print "<tr>";
          ...
          print "</td></tr>";
        print "<tr>";
          print "<td>Desde Fecha</td><td>$tb$tb$tb :</td>";
          print "<td><input name='fec_df_i' size='6' value='$axn_fecha'></td>";
          print "<td></tr>";
        print "<tr>";
          print "<td>Hasta Fecha</td><td>$tb$tb$tb :</td>";
