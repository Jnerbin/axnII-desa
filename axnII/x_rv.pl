...
#                print "<td>$tiempo_tot</td>";
        print "<td><a href='/cgi-bin/axnII/x_ct.pl?$pos_ini[2],$pos_ant[2],$fecha,$ip'> $tiempo_tot</a></td>";
              print "</TR>";
           }
   ...
   print "<div style='text-align:left;'><br>";
      print "<TABLE>";
        ...
        print "<tr>";
          ...
          print "<td><input name='min_vel' size='3' value='90'>$tb Km/hr<br></td>";
          print "<td></tr>";
        print "<tr>";
          print "<td>Lapso de Tiempo Mayor a </td><td>$tb$tb$tb :</td>";
          print "<td><input name='min_tpo' size='3' value='5'>$tb minutos<br></td>";
          print "<td></tr>";
      print "</TABLE>";
