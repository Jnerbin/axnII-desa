...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <TABLE>
    <TR>
       <td>
         <div id="menu"><p>
         <a href="/projects/gmaps">home</a> | <a href="/maps.shtml">maps</a> | 
         <a href="/data/">geodata</a> | <a href="/software.shtml">software</a> | 
         <a href="/projects.shtml">projects</a></p> 
         </div>
       </td>
    </TR>
    <TR>
       <TABLE>
		 ...
		 <form>
             ...
             <td>
                 <div id="map" style="width: 640px; height: 480"></div>
             </td>
          </TR>
       </TABLE>
    </TR>
...
//     map.setCenter(new GLatLng( -34.88713, -56.11781), 15);
	...
	request.open("GET", "/axnII/tmp/671.xml", true);
 	request.onreadystatechange = function() {
	  if (request.readyState == 4) {
		...
		// Sets a marker to the last point added in the database
                ...
                var  texto = "<b> MOVIL: " + markers[i].getAttribute("id") + " <br>";
		...
		if ( 0 > 0) {
          ...
          // ===== determine the centre from the bounds ======
                 ...
                 map.setZoom(14);
                 map.setCenter(new GLatLng(-34.88713,-56.11781));
	       }
               ingreso = 0;
             }
	  }
...
if ( $KCantV > 0) {
  my $EstZ = 0;
  my $NorZ = 0;
# No va mas, la version 2 autocalcula el mejor zoom
##  my ($xeste, $xnort) = DistP1P2WGS84($Klat1, $Klon1, $Klat2, $Klon2);
##  $xeste = abs($xeste);
##  $xnort = abs($xnort);
##  if    ($xeste >  600) { $EstZ = 5; }
##  elsif ($xeste <= 600 && $xeste > 300) { $EstZ = 6; }
##  elsif ($xeste <= 300 && $xeste > 100) { $EstZ = 7; }
##  elsif ($xeste <= 100 && $xeste > 50)  { $EstZ = 8; }
##  elsif ($xeste <= 50  && $xeste > 25)  { $EstZ = 9; }
##  elsif ($xeste <= 25  && $xeste > 16)  { $EstZ = 10; }
##  elsif ($xeste <= 16  && $xeste > 6)   { $EstZ = 11; }
##  else  { $EstZ = 12; }
##  if    ($xnort >  600) { $NorZ = 5; }
##  elsif ($xnort <= 600 && $xnort > 300) { $NorZ = 6; }
##  elsif ($xnort <= 300 && $xnort > 100) { $NorZ = 7; }
##  elsif ($xnort <= 100 && $xnort > 50)  { $NorZ = 8; }
##  elsif ($xnort <= 50  && $xnort > 25)  { $NorZ = 9; }
##  elsif ($xnort <= 25  && $xnort > 16)  { $NorZ = 10; }
##  elsif ($xnort <= 16  && $xnort > 6)   { $NorZ = 11; }
##  else  { $NorZ = 12; }
  ...
  <body onload="onLoad()" onunload="GUnload()">
    ...
    <table border=1 style="width: 100%; height: 100%">
      <tr>
        ...
        <td width = 80 valign="top" style="text-decoration: underline; color: #4444ff;">
           <div id="sidebar"></div>
        </td>
      </tr>
      <tr>
        <td height = 25px>
           ...
           <img src="/axnII/images/mm_20_red.png"> 100+</img>
