...
use vars qw ($dbh $cgi $Kmapa $Knivel $Kcateg $Klat1 $Klon1 $Klat2 $Klon2 $K_Estado
             ...
             $URL_XML $URL_HTML $GM_ZOOM $GM_KEY $KCantV $KBorde $KCantVehiculos
             @ip_user $ip_string);
...
# cgi-bin/axnII/
$GM_KEY = "ABQIAAAAXwxNGyleOVAL1oKtaNhnCxQUQFmRpjs33K9oj-ZRfsu6f4nlvhT9UQY3FsVdeMnEwYssDjvb5bTWAQ";
...
#print "Son : $KCantVehiculos<br>";
  ...
  while (my @ultimapos=$ptrup->fetchrow_array ) {
     ...
     if ($ptrlv >= 1) {
        ...
        push @{$dat_vehiculo[$ind]}, $l_nom, $l_fec, $l_hor, $l_vel, $l_hors, $l_img, $xhs, $vehiculos[2];
#        push @{$dat_vehiculo[$ind]}, $l_nom, $l_fec, $l_hor, $l_vel, $l_hors, $l_img, $l_hrstop, $vehiculos[2];
        $ind += 1;
     } 
  }
}
...
sub DesplegarResultados {
  ...
  print "<TABLE BORDER='0' style='text-aLIgn: left; margin-left: auto; margin-right: auto;'><span style='font-family:Arial'>";
   ...
   print "</TR>";
  print "</TABLE>";
  print "<TABLE BORDER='5' style='text-aLIgn: left; margin-left: auto; margin-right: auto;width: 100%; height: 80% '><span style='font-family:Arial'>";
   print "<TR align='center'><td>";
      print "<TABLE BORDER='0' style='text-align: left; margin-left: auto; margin-right: auto;'>";
       print "<tr><td style='vertical-align: top;'> <div id='map' style='width: 100%; height: 100%'></div>";
          CrearGM($Klat1, $Klon1, $Klat2, $Klon2);
       print "</td></tr>";
      print "</TABLE>";
    print "</td>";
    print "<td  style='vertical-align: top;'>";
      ...
      print "<TR style='background-color: yellow;'>";
        ...
        print "<td><font size='-1'><span style='font-family:Arial'>Hora<br>Ult Pos</td>";
        print "<td><font size='-1'><span style='font-family:Arial'>Vel</td>";
        if ($K_Estado eq 'Parados' or $K_Estado eq 'Todos') {
           print "<td><font size='-1'><span style='font-family:Arial'>Tpo.<br>Stop</td>";
           print "<td><font size='-1'><span style='font-family:Arial'>Hora<br>Stop</td>";
        }
      print "</TR>";
      for $i (0..$#datos) {
        my $bkgc = "white";
...
print  <<END
    <table style='width: 600px; height: 400px'>
     ...
     var cuantos = $KCantV;    
     var xIcon = new GIcon();
     xIcon.image      = "http://201.229.186.162/axnII/iconos/dir/red-000.png";
     xIcon.shadow     = "http://201.229.186.162/axnII/iconos/dir/shadow.png";
...
//     map.setCenter(new GLatLng( $latm, $lonm), $GM_ZOOM);
     ...
     map.setMapType( G_SATELLITE_MAP );
      ...
      function get_icon(velocidad, direccion) {
        ...
        xIcon.image   = "http://201.229.186.162/axnII/iconos/dir/"+nombre;
        return xIcon;
      }
