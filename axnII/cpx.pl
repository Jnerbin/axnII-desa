...
print '  else';
print '  href=mylink.href;';
print '  window.open(href, "AXN", "status=no, width=500,height=350,resizable=1");';
print '  return false;';
print '  }';
print '  //-->';
print '  </SCRIPT>';
...
#     print "<a href='$URL_HTML' onclick='return popgm('$URL_HTML')'><img border=\"0\" src=\"/axnII/gmap.png\"></a>";
    print "</td>";
   print "</TR>";
  print "</TABLE>";
  print "<TABLE BORDER='0' style='text-aLIgn: left; margin-left: auto; margin-right: auto;'><span style='font-family:Arial'>";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script src=\"http://maps.google.com/maps?file=api&v=1&key=$GM_KEY\" type=\"text/javascript\">
    </script>
    <SCRIPT TYPE="text/javascript">
    <!--
    window.focus();
