...
use vars qw ($dbh $cgi $Kmapa $Knivel $Kcateg $Klat1 $Klon1 $Klat2 $Klon2 $K_Estado
             ...
             $HTML_GM $URL_XML $URL_HTML $GM_ZOOM $GM_KEY $KCantV $KBorde $KCantVehiculos
             @ip_user $ip_string);
...
#print "$ahora $vtime2 $vtime $tpdif <br>";
        ...
        for $j (0..($#{ $datos[$i] } - 1 )) {
           if ( $j == 0 ) {
             ...
             print  submit(-name=>'lst_marcas', -value=>"$xxvel $bt");
           } elsif ($j == 1) {
             if ($KUPT eq 'KK') {
...
#                my $xhs = $ptrp->fetchrow_array; # Ultima hora andando
  ...
  print "<TABLE>";
   ...
   print "<td style='background-color: red;font-size:70%'>Detenido.  Mas de 30 min. Motor ON";
   print "<td style='background-color: orange;font-size:70%'>Detenido. Menos de 30 min. Motor ON";
   print "<td style='background-color: yellow;font-size:70%'>Detenido. Menos de 10 min. Motor ON";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body onload="onLoad()" onunload="GUnload()">
    ...
    <table border=1 style="width: 100%; height: 100%">
     ...
     var cuantos = $KCantV;    
     var xIcon = new GIcon();
     xIcon.image      = "http://www.gpdom.com.do/axnII/iconos/dir/red-000.png";
     xIcon.shadow     = "http://www.gpdom.com.do/axnII/iconos/dir/shadow.png";
...
//     map.setCenter(new GLatLng( $latm, $lonm), $GM_ZOOM);
     ...
     map.setMapType( G_SATELLITE_MAP );
      ...
      function get_icon(velocidad, direccion) {
        ...
        xIcon.image   = "http://www.gpdom.com.do/axnII/iconos/dir/"+nombre;
        return xIcon;
      }
